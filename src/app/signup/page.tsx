  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <p className={styles.subtitle}>Join PodcastVille — free forever</p>
        ...
        <p className={styles.privacyText}>
          By creating an account, you agree to PodcastVille&apos;s{' '}
        ...
        <p className={styles.bottomText}>
          ...
          <Link href="/signin" className={styles.bottomLink}>Sign in</Link>
        </p>
